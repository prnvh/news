...
```txt
Content error in articles/essays/2026-05-23-beyond-scale-obsession.mdx:
...
```txt
1. Copy articles/_templates/brief-template.mdx
2. Put it in articles/briefs/YYYY-MM-DD-slug.mdx
3. Fill frontmatter
4. Write body
...
```txt
1. Copy articles/_templates/research-note-template.mdx
2. Put it in articles/research-notes/YYYY-MM-DD-slug.mdx
...
```txt
1. Copy articles/_templates/essay-template.mdx
2. Put it in articles/essays/YYYY-MM-DD-slug.mdx
3. Write body
